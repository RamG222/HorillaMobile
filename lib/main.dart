...
Future<void> markAllReadNotification() async {
  ...
  var uri = Uri.parse(
    '$typed_serverUrl/api/notifications/notifications/bulk-read/',
  );
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (fetchedNotifications.isNotEmpty) {
        ...
        bool hasNewNotifications = newNotificationIds.any(
          (id) => !seenNotificationIds.contains(id),
        );
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Image.asset('Assets/horilla-logo.png', width: 150, height: 150),
          ],
        ),
      ),
    );
