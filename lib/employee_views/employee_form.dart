...
import '/employee_views/rotating_shift.dart';
import '/employee_views/rotating_work_type.dart';
import '/employee_views/shift_request.dart';
import '/employee_views/work_type_request.dart';
...
class _EmployeeFormPageState extends State<EmployeeFormPage>
  ...
  void prefetchData() async {
    ...
    if (response.statusCode == 200) {
      ...
      arguments = {
        ...
        'employee_name':
            responseData['employee_first_name'] +
            ' ' +
  ...
  Future<void> updateEmployeeBankInfoDetails(
    ...
    if (employeeBankId.isEmpty) {
      var uri = Uri.parse(
        '$typedServerUrl/api/employee/employee-bank-details/',
      );
  ...
  Future<void> _pickImage(int id) async {
    ...
    if (file != null) {
      setState(() async {
        ...
        filePath = file.path;
        checkFile = true;
        Map<String, dynamic> updatedDetails = {"id": id};
  ...
  void _showEditPersonalInfo(
    ...
    TextEditingController emailController = TextEditingController(
      text: employeeDetails['email']?.toString() ?? '',
    );
    TextEditingController phoneController = TextEditingController(
      text: employeeDetails['phone']?.toString() ?? '',
    );
    TextEditingController birthController = TextEditingController(
      text: employeeDetails['dob']?.toString() ?? '',
    );
    ...
    TextEditingController stateController = TextEditingController(
      text: employeeDetails['state']?.toString() ?? '',
    );
    TextEditingController cityController = TextEditingController(
      text: employeeDetails['city']?.toString() ?? '',
    );
    TextEditingController zipCodeController = TextEditingController(
      text: employeeDetails['zip']?.toString() ?? '',
    );
  ...
  void _showEditWorkInfo(
    ...
    TextEditingController reportingManagerController = TextEditingController(
      text:
          employeeWorkInfoRecord['reporting_manager_first_name']?.toString() ??
          '',
    );
                          ...
                          if (joiningDateController.text.isEmpty) {
                            ...
                            Map<String, dynamic> updatedDetails = {
                              ...
                              "reporting_manager_id":
                                  selectedReportingManager ??
                                  employeeWorkInfoRecord['reporting_manager_id'],
                              "company_id":
                                  selectedCompany ??
  ...
  void _showEditOptions(
    ...
    List<PopupMenuEntry<String>> menuItems = [
      const PopupMenuItem(value: 'personal', child: Text('Personal Info')),
      const PopupMenuItem(value: 'bank', child: Text('Bank Info')),
    ];

    if (employeeDetails['id'] != null && employeeDetails['id'] != employeeId) {
      menuItems.insert(
        1,
        const PopupMenuItem(value: 'work', child: Text('Work Info')),
      );
    }
...
''';
  ...
  Widget buildTabContentAbout(
    ...
    genderController.text = (gender != null && gender.isNotEmpty)
        ? gender
        : 'None';
    var address = employeeDetails['address'];
    addressController.text = (address != null && address.isNotEmpty)
        ? address
        : 'None';
    var country = employeeDetails['country'];
    countryController.text = (country != null && country.isNotEmpty)
        ? country
        : 'None';
    ...
    tagsController.text =
        (employeeWorkInfoRecord['tags'] is List &&
